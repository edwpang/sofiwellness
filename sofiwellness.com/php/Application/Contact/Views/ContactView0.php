...
$addrText = 'Greenhill Rehab Clinic';
$gmJs = '$(function() {
...
<div id='content_left' style='width:35%;'>


<div id="info" style="width:80%; margin:50px 40px;">
<h3>Office Hour:</h3>
<p>
...
<br/>
<img src="images/sys/office.png">

</div>

</div>

<div id='content_right' style="width:60%; margin-right:20px;">

<div id="myMap" style="width: 95%;height: 450px;border:1px solid #666; margin-top:50px;"></div>
